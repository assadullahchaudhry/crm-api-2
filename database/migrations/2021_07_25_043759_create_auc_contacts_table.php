...
class CreateAucContactsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('auc_contacts', function (Blueprint $table) {
            ...
            $table->string('ownerPhones')->nullable();
    ...
    {
        Schema::dropIfExists('auc_contacts');
    }
}
